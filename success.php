                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            ...
                            <div class="column small-12 as-search-results-tiles as-search-results-width">
                                ...
                                <h3>Parabéns! Seu pedido foi concluido com sucesso!</h3>

                                <p>Abaixos segue um resumo do seu pedido</p>
                                <hr>
                                <p>Forma de pagamento: 

                                <?php if($_GET['payment_type'] == 'credit_card'): ?>
                                    Cartão de crédito
                                <?php elseif($_GET['payment_type'] == 'ticket'): ?>

                                Boleto bancário
                                
                                <?php elseif($_GET['payment_type'] == 'account_money'): ?>

                                Dinheiro em conta

                                <?php elseif($_GET['payment_type'] == 'digital_currency'): ?>
                                    
                                Gift card

                                <?php elseif($_GET['payment_type'] == 'digital_wallet'): ?>
                                
                                Paypal

                                <?php elseif($_GET['payment_type'] == 'bank_transfer'): ?>
                                ...
                                <p>ID do pagamento: <?php echo $_GET['payment_id']; ?></p>
