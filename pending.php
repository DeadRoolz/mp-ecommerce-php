                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            ...
                            <div class="column small-12 as-search-results-tiles as-search-results-width">
                                ...
                                <?php if($_GET['payment_type'] == 'credit_card'): ?>
                                    <p>Você escolheu pagar com cartão de crédito, assim que seu pagamento for processado, iremos iniciar o processo de envio do seu novo  produto!</p>
                                <?php else: ?>
                                    <p>Efetue o pagamento do seu pedido, assim que confirmamos o pagamento, faremos o envio do seu produto!</p>
                                    <?php endif ?>
